...
var menus = avalon.define({
    ...
    menus: [
        {
            icon: githublocation + + __themeName + '/home_home_icon.png',
            text: '首页',
        ...
        {
            icon: githublocation + + __themeName + '/home_working_icon.png',
            text: '我的工作台',
        ...
        {
            icon: githublocation + + __themeName + '/home_organ_icon.png',
            text: '机构用户',
            url: '',
            open: false,
            child: [
        ...
        {
            icon: githublocation + + __themeName + '/home_set_icon.png',
            text: '系统设置',
            url: '',
            open: false,
            child: [
