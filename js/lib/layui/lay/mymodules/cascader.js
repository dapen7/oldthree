    ...
    Cascader.prototype={
        ...
        initFirst: function () {
            ...
            for(var i=0;i<this.d.length;i++){
                (this.d[i] && this.d[i]["children"] && this.d[i]["children"].length>0)?(
        ...
        initChild: function (triggerData) {
            ...
            // 显示隐藏第二层的标签
            if(this.blockData["children"].length>0){
                for(var i=0;i<this.blockData["children"].length;i++){
                    if(this.blockData["children"][i] && this.blockData["children"][i]["children"] && this.blockData["children"][i]["children"].length>0){
