      ...
      child: [
        {
          ...
          child: [
            {icon: '', text: '机构信息', url: '/views/organization/list.' + __themeName + mobile + '.html', open: false}
          ]
        },
        {icon: '', text: '用户管理', url: '/views/organization/add.' + __themeName + mobile + '.html', open: false, child: []},
        {icon: '', text: '质卡填报', url: '/views/organization/add2.' + __themeName + mobile + '.html', open: false, child: []}
      ]
    },
    {
      ...
      open: false,
      child: [
        {icon: '', text: '字典管理', url: '/views/dictionary/list.' + __themeName + mobile + '.html', open: false, child: []}
      ]
    },
    {
      icon: '/img/access/' + __themeName + '/home_set_icon.png',
      ...
      open: false,
      child: [
        {icon: '', text: '策划目录', url: '/views/project/add.' + __themeName + mobile + '.html', open: false, child: []}
      ]
    }
  ],
